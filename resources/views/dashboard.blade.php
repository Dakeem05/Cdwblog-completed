            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="pt-4">
                        ...
                        <div>
                             <a href="{{route('articles.edit', $article->slug)}}" class="inline-flex text-md pb-6 pt-8 items-center py-2 leading-4 font-medium rounded-md text-orange-400 hover:text-orange-300 focus:outline-none transition ease-in-out duration-150 float-right">Update</a>


                             <form action="{{route('articles.destroy', $article->slug)}}" method="post" > @csrf @method('DELETE')
